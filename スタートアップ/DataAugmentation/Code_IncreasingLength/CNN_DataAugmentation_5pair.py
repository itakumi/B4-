...
def plot():
    ...
    plt.ylabel('loss')
    plt.legend()
    plt.savefig('img/{}kind_CNN_cifar10_loss{}_1to{}.png'.format(n_kinds,Data_Augmentation,epochstart+epoch))
    plt.close()
    ...
    plt.ylabel('accuracy')
    plt.legend()
    plt.savefig('img/{}kind_CNN_cifar10_acc{}_1to{}.png'.format(n_kinds,Data_Augmentation,epochstart+epoch))
